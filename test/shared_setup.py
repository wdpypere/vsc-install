...
class TestSetup(TestCase):
    ...
    def test_sanitize(self):
        ...
        self.assertEqual(shared_setup.PYTHON_BDIST_RPM_PREFIX_MAP, {'pycrypto': 'python%s-crypto', 'psycopg2': 'python%s-psycopg2', 'python-ldap': 'python%s-ldap', 'pyasn1_modules': 'python%s-pyasn1-modules'},
