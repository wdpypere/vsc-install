...
class CommonTest(TestCase):
    ...
    def check_autogenerated_ci_config_file(self, ci_cfg_fn, expected_contents):
        """Test whether specified CI configuration file is in place, and was auto-generated by vsc-install."""
        self.assertTrue(os.path.exists(ci_cfg_fn))
        ...
        if os.path.exists(ci_cfg_ignore_fn):
            ...
            self.assertNotEqual(current_contents, expected_contents, error_msg)
        else:
            error_msg = "Contents of %s does not match expected contents, " % ci_cfg_fn
            error_msg += "you should run 'pyton -m vsc.install.ci' again to re-generate %s" % ci_cfg_fn
            self.assertEqual(current_contents, expected_contents, error_msg)

    def test_jenkinsfile(self):
        """Test whether Jenkinsfile is in place, and was auto-generated by vsc-install."""
        self.check_autogenerated_ci_config_file(JENKINSFILE, gen_jenkinsfile())

    def test_tox_ini(self):
        """Test whether tox.ini is in place, and was auto-generated by vsc-install."""
        self.check_autogenerated_ci_config_file(TOX_INI, gen_tox_ini())
