...
from vsc.install.ci import (
    JENKINSFILE, TOX_INI, GITHUB_ACTIONS, gen_jenkinsfile, gen_tox_ini,
...
def check_autogenerated_ci_config_file(testcase_instance, ci_cfg_fn, expected_contents):
    ...
    with open(ci_cfg_fn, encoding='utf8') as fih:
        current_contents = fih.read()
    ...
    if os.path.exists(ci_cfg_ignore_fn):
        ...
        with open(ci_cfg_ignore_fn, encoding='utf8') as ignore_file:
            txt = ignore_file.read()
